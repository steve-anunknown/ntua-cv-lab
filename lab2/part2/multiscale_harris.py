...
if __name__ == "__main__":
    ...
    harris_points = MultiscaleDetector(lambda video, sigma, tau: HarrisDetector(video, 2, sigma, tau, kappa=0.005, threshold=0.05),
                                       video, [3*(1.1**i) for i in range(8)], tau=1.5)
